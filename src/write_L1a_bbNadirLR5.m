...
function write_L1a_bbNadirLR5(IntegrationMidPointTime, geoSYSp, Rx, DDMOutputNumericalScaling_NLblackbody_DOWNmax, DDMPixelValueNoiseWholeDDM_down,...
...
FrontEnd                             = repmat(2,size(IntegrationMidPointTime));
...
%% attributes
netcdf.putAtt(ncid, netcdf.getConstant("NC_GLOBAL"),'Name','HydroGNSS L1a blackbodyNadirL5E5LHCP.nc');
