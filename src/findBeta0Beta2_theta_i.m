function beta_optx = findBeta0Beta2_theta_i(R0, Rs, lambda, Pt, sigma_z, ...
...
figure;
imagesc(beta0_val, beta2_vals, ABSe_matrix);

xlabel('\beta_0');
ylabel('\beta_2');
title('ABSe vs. \beta_0 and \beta_2');
colorbar;
axis xy; 
...
%% Save result
save('C:\Users\jalef\Downloads\betc_new_july\v1\BetaC_H3000_Inc52.mat', 'beta_opt');
