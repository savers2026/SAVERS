...
function [NoisySignalPowerAnt_LR, NoisySignalPowerAnt_RR, NLbb_LHCP, NLbb_RHCP, G_sys_lin_LHCP, G_sys_lin_RHCP, G_sys_lin_LHCP_nominal , G_sys_lin_RHCP_nominal] = gen_noise_sys(NoiseFreeSignalPowerAnt_LR, NoiseFreeSignalPowerAnt_RR, geoSYSp)
...
Tref_K = geoSYSp.ReceiverTemperature_K; %Tref_K
