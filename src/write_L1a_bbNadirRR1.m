...
function write_L1a_bbNadirRR1(IntegrationMidPointTime, geoSYSp, Rx, DDMOutputNumericalScaling_NLblackbody_DOWNmax, DDMPixelValueNoiseWholeDDM_down,...
...
FrontEnd                             = ones(size(IntegrationMidPointTime));
...
%% attributes
netcdf.putAtt(ncid, netcdf.getConstant("NC_GLOBAL"),'Name','HydroGNSS L1a blackbodyNadirL1E1RHCP.nc');
