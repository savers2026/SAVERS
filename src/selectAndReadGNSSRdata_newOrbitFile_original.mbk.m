...
Rxlat_selectedSiteAndTx=Rx_lat(indexRxLatLonSelectedSiteAndTx);
Rxlon_selectedSiteAndTx=Rx_lon(indexRxLatLonSelectedSiteAndTx);
...
if flagMode==1 || flagMode==2 % Single point or Trackwise
    ...
    SPlat_selectedSiteAndTx = SPlat_selectedSiteAndTx_all(trackID_selectedSiteAndTx == trackID_start); %amir
    SPlon_selectedSiteAndTx = SPlon_selectedSiteAndTx_all(trackID_selectedSiteAndTx == trackID_start); %amir
    indexSP_start=find(SPlat_selectedSiteAndTx==latSP_start &SPlon_selectedSiteAndTx==lonSP_start); % checking SPlon Added by Amir for Grass/Great Project   
    ...
    switch mode1
        ...
        case 'Trackwise'
            ...
            while trackCheckFlag<3        
                ...
                SPlat_selectedSiteAndTx = SPlat_selectedSiteAndTx_all(trackID_selectedSiteAndTx == trackID_end); %amir
                SPlon_selectedSiteAndTx = SPlon_selectedSiteAndTx_all(trackID_selectedSiteAndTx == trackID_end); %amir
                indexSP_end=find(SPlat_selectedSiteAndTx==latSP_end &SPlon_selectedSiteAndTx==lonSP_end); % checking SPlon Added by Amir for Grass/Great Project   
