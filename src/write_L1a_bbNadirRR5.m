...
function write_L1a_bbNadirRR5(IntegrationMidPointTime, geoSYSp, Rx, DDMOutputNumericalScaling_NLblackbody_DOWNmax, DDMPixelValueNoiseWholeDDM_down,...
...
FrontEnd                             = repmat(3,size(IntegrationMidPointTime));
...
[a2,~]  = size(Doppler);
signalpolarization = 'RHCP';
filename = ['blackbodyNadirL5E5' signalpolarization '.nc'];
...
%% attributes
netcdf.putAtt(ncid, netcdf.getConstant("NC_GLOBAL"),'Name','HydroGNSS L1a blackbodyNadirL5E5RHCP.nc');
